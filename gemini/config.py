...
class GeminiConfig:
    ...
    def from_yaml(cls, config_path: Optional[str] = None) -> 'GeminiConfig':
        ...
        config = cls(
            ...
            registry_path=gemini_config.get('registry_path', 'gemini/store_registry.json'),
            upload_tracking_path=gemini_config.get('upload_tracking_path', 'gemini/upload_tracking.json'),
            force_reupload=gemini_config.get('force_reupload', False),
            supported_formats=yaml_config.get('supported_formats', ['.txt', '.md', '.pdf', '.docx'])
        )
